...
This will list all endpoints by default. You can narrow down the items
returned using index filters. Use the “indexes” command to get the
indexes available for endpoints.
...
::
   ...
   drpcli endpoints list [filters...] [flags]
