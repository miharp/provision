drpcli endpoints get
--------------------

Get a parameter from the endpoint

Synopsis
~~~~~~~~

A helper function to return the value of the parameter on the endpoint

::

   drpcli endpoints get [id] param [key] [flags]
