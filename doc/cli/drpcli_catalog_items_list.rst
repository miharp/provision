drpcli catalog_items list
-------------------------

List all catalog_items

Synopsis
~~~~~~~~

This will list all catalog_items by default. You can narrow down the
items returned using index filters. Use the “indexes” command to get the
indexes available for catalog_items.
...
::
   ...
   drpcli catalog_items list [filters...] [flags]
