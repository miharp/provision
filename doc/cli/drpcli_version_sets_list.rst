drpcli version_sets list
------------------------

List all version_sets

Synopsis
~~~~~~~~

This will list all version_sets by default. You can narrow down the
items returned using index filters. Use the “indexes” command to get the
indexes available for version_sets.
...
::
   ...
   drpcli version_sets list [filters...] [flags]
